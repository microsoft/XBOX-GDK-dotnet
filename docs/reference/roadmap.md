...
|---|---|---|---|---|---|
| Runtime init & feature gating | `XGameRuntime.h`, `XGameRuntimeInit.h`, `XGameRuntimeFeature.h` | G | init/lifecycle; feature detection; precondition for **everything** | — | P0 |
...
| Family | Header(s) | Shape | Purpose / unlocks | Depends on | Tier |
|---|---|---|---|---|---|
| PlayFab Core / Entity | `core/PFCore.h`, `PFServices.h`, `PFServiceConfig.h`, `PFEntity.h`, `PFEntityKey.h` | A | init, service config, reference-counted entity handle; **foundation for all PlayFab** | — | P1 |
...
| Party | `party/Party_c.h` (`Party.h` C++) | S | realtime networking + voice/text transport | — | P1 |
