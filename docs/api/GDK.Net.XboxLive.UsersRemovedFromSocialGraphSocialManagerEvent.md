# <a id="GDK_Net_XboxLive_UsersRemovedFromSocialGraphSocialManagerEvent"></a> Class UsersRemovedFromSocialGraphSocialManagerEvent
...
```csharp
public sealed record UsersRemovedFromSocialGraphSocialManagerEvent : SocialManagerEvent, IEquatable<SocialManagerEvent>, IEquatable<UsersRemovedFromSocialGraphSocialManagerEvent>
```
...
[IEquatable<UsersRemovedFromSocialGraphSocialManagerEvent\>](https://learn.microsoft.com/dotnet/api/system.iequatable\-1)
...
### <a id="GDK_Net_XboxLive_UsersRemovedFromSocialGraphSocialManagerEvent_Users"></a> Users

The users removed from the graph.
