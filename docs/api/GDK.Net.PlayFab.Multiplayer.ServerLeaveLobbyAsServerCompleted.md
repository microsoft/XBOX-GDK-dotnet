# <a id="GDK_Net_PlayFab_Multiplayer_ServerLeaveLobbyAsServerCompleted"></a> Class ServerLeaveLobbyAsServerCompleted
...
```csharp
public sealed record ServerLeaveLobbyAsServerCompleted : LobbyOperationCompleted, IEquatable<LobbyStateChange>, IEquatable<LobbyOperationCompleted>, IEquatable<ServerLeaveLobbyAsServerCompleted>
```
...
[IEquatable<ServerLeaveLobbyAsServerCompleted\>](https://learn.microsoft.com/dotnet/api/system.iequatable\-1)
