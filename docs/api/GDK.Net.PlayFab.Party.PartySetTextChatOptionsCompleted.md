# <a id="GDK_Net_PlayFab_Party_PartySetTextChatOptionsCompleted"></a> Class PartySetTextChatOptionsCompleted

Namespace: [GDK.Net.PlayFab.Party](GDK.Net.PlayFab.Party.md)  
Assembly: GDK.Net.dll  

A <xref href="GDK.Net.PlayFab.Party.PartyChatControl.SetTextChatOptions(GDK.Net.PlayFab.Party.PartyTextChatOptions)" data-throw-if-not-resolved="false"></xref> call completed.

```csharp
public sealed record PartySetTextChatOptionsCompleted : PartyOperationCompleted, IEquatable<PartyStateChange>, IEquatable<PartyOperationCompleted>, IEquatable<PartySetTextChatOptionsCompleted>
```
...
[IEquatable<PartySetTextChatOptionsCompleted\>](https://learn.microsoft.com/dotnet/api/system.iequatable\-1)
...
### <a id="GDK_Net_PlayFab_Party_PartySetTextChatOptionsCompleted__ctor_GDK_Net_PlayFab_Party_PartyOperationId_GDK_Net_PlayFab_Party_PartyStateChangeResult_System_UInt32_GDK_Net_PlayFab_Party_PartyChatControl_GDK_Net_PlayFab_Party_PartyTextChatOptions_"></a> PartySetTextChatOptionsCompleted\(PartyOperationId, PartyStateChangeResult, uint, PartyChatControl?, PartyTextChatOptions\)

A <xref href="GDK.Net.PlayFab.Party.PartyChatControl.SetTextChatOptions(GDK.Net.PlayFab.Party.PartyTextChatOptions)" data-throw-if-not-resolved="false"></xref> call completed.

```csharp
public PartySetTextChatOptionsCompleted(PartyOperationId Operation, PartyStateChangeResult Result, uint ErrorDetail, PartyChatControl? ChatControl, PartyTextChatOptions Options)
```
...
### <a id="GDK_Net_PlayFab_Party_PartySetTextChatOptionsCompleted_ChatControl"></a> ChatControl
...
### <a id="GDK_Net_PlayFab_Party_PartySetTextChatOptionsCompleted_Options"></a> Options

The options that were requested.

```csharp
public PartyTextChatOptions Options { get; init; }
```
