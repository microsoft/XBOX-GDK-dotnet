# <a id="GDK_Net_PlayFab_Party_PartyDisconnectChatControlCompleted"></a> Class PartyDisconnectChatControlCompleted

Namespace: [GDK.Net.PlayFab.Party](GDK.Net.PlayFab.Party.md)  
Assembly: GDK.Net.dll  

A <xref href="GDK.Net.PlayFab.Party.PartyNetwork.DisconnectChatControl(GDK.Net.PlayFab.Party.PartyChatControl)" data-throw-if-not-resolved="false"></xref> call completed.

```csharp
public sealed record PartyDisconnectChatControlCompleted : PartyOperationCompleted, IEquatable<PartyStateChange>, IEquatable<PartyOperationCompleted>, IEquatable<PartyDisconnectChatControlCompleted>
```
...
[IEquatable<PartyDisconnectChatControlCompleted\>](https://learn.microsoft.com/dotnet/api/system.iequatable\-1)
...
### <a id="GDK_Net_PlayFab_Party_PartyDisconnectChatControlCompleted__ctor_GDK_Net_PlayFab_Party_PartyOperationId_GDK_Net_PlayFab_Party_PartyStateChangeResult_System_UInt32_GDK_Net_PlayFab_Party_PartyNetwork_GDK_Net_PlayFab_Party_PartyChatControl_"></a> PartyDisconnectChatControlCompleted\(PartyOperationId, PartyStateChangeResult, uint, PartyNetwork?, PartyChatControl?\)

A <xref href="GDK.Net.PlayFab.Party.PartyNetwork.DisconnectChatControl(GDK.Net.PlayFab.Party.PartyChatControl)" data-throw-if-not-resolved="false"></xref> call completed.

```csharp
public PartyDisconnectChatControlCompleted(PartyOperationId Operation, PartyStateChangeResult Result, uint ErrorDetail, PartyNetwork? Network, PartyChatControl? ChatControl)
```
...
### <a id="GDK_Net_PlayFab_Party_PartyDisconnectChatControlCompleted_ChatControl"></a> ChatControl
...
### <a id="GDK_Net_PlayFab_Party_PartyDisconnectChatControlCompleted_Network"></a> Network
