# <a id="GDK_Net_PlayFab_Multiplayer_CreateAndClaimServerLobbyCompleted"></a> Class CreateAndClaimServerLobbyCompleted
...
```csharp
public sealed record CreateAndClaimServerLobbyCompleted : LobbyOperationCompleted, IEquatable<LobbyStateChange>, IEquatable<LobbyOperationCompleted>, IEquatable<CreateAndClaimServerLobbyCompleted>
```
...
[IEquatable<CreateAndClaimServerLobbyCompleted\>](https://learn.microsoft.com/dotnet/api/system.iequatable\-1)
