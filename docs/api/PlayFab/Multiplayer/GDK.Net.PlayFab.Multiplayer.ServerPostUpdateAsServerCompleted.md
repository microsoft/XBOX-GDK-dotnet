# <a id="GDK_Net_PlayFab_Multiplayer_ServerPostUpdateAsServerCompleted"></a> Class ServerPostUpdateAsServerCompleted
...
```csharp
public sealed record ServerPostUpdateAsServerCompleted : LobbyOperationCompleted, IEquatable<LobbyStateChange>, IEquatable<LobbyOperationCompleted>, IEquatable<ServerPostUpdateAsServerCompleted>
```
...
[IEquatable<ServerPostUpdateAsServerCompleted\>](https://learn.microsoft.com/dotnet/api/system.iequatable\-1)
