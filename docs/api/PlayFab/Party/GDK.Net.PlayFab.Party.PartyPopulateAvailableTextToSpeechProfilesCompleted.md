# <a id="GDK_Net_PlayFab_Party_PartyPopulateAvailableTextToSpeechProfilesCompleted"></a> Class PartyPopulateAvailableTextToSpeechProfilesCompleted

Namespace: [GDK.Net.PlayFab.Party](GDK.Net.PlayFab.Party.md)  
Assembly: GDK.Net.dll  

A <xref href="GDK.Net.PlayFab.Party.PartyChatControl.PopulateAvailableTextToSpeechProfiles" data-throw-if-not-resolved="false"></xref> call completed.

```csharp
public sealed record PartyPopulateAvailableTextToSpeechProfilesCompleted : PartyOperationCompleted, IEquatable<PartyStateChange>, IEquatable<PartyOperationCompleted>, IEquatable<PartyPopulateAvailableTextToSpeechProfilesCompleted>
```
...
[IEquatable<PartyPopulateAvailableTextToSpeechProfilesCompleted\>](https://learn.microsoft.com/dotnet/api/system.iequatable\-1)
...
### <a id="GDK_Net_PlayFab_Party_PartyPopulateAvailableTextToSpeechProfilesCompleted__ctor_GDK_Net_PlayFab_Party_PartyOperationId_GDK_Net_PlayFab_Party_PartyStateChangeResult_System_UInt32_GDK_Net_PlayFab_Party_PartyChatControl_"></a> PartyPopulateAvailableTextToSpeechProfilesCompleted\(PartyOperationId, PartyStateChangeResult, uint, PartyChatControl?\)

A <xref href="GDK.Net.PlayFab.Party.PartyChatControl.PopulateAvailableTextToSpeechProfiles" data-throw-if-not-resolved="false"></xref> call completed.

```csharp
public PartyPopulateAvailableTextToSpeechProfilesCompleted(PartyOperationId Operation, PartyStateChangeResult Result, uint ErrorDetail, PartyChatControl? ChatControl)
```
...
### <a id="GDK_Net_PlayFab_Party_PartyPopulateAvailableTextToSpeechProfilesCompleted_ChatControl"></a> ChatControl
