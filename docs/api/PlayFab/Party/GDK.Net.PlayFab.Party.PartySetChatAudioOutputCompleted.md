# <a id="GDK_Net_PlayFab_Party_PartySetChatAudioOutputCompleted"></a> Class PartySetChatAudioOutputCompleted

Namespace: [GDK.Net.PlayFab.Party](GDK.Net.PlayFab.Party.md)  
Assembly: GDK.Net.dll  

A <xref href="GDK.Net.PlayFab.Party.PartyChatControl.SetAudioOutput(GDK.Net.PlayFab.Party.PartyAudioDeviceSelectionType%2cSystem.String)" data-throw-if-not-resolved="false"></xref> call completed.

```csharp
public sealed record PartySetChatAudioOutputCompleted : PartyOperationCompleted, IEquatable<PartyStateChange>, IEquatable<PartyOperationCompleted>, IEquatable<PartySetChatAudioOutputCompleted>
```
...
[IEquatable<PartySetChatAudioOutputCompleted\>](https://learn.microsoft.com/dotnet/api/system.iequatable\-1)
...
### <a id="GDK_Net_PlayFab_Party_PartySetChatAudioOutputCompleted__ctor_GDK_Net_PlayFab_Party_PartyOperationId_GDK_Net_PlayFab_Party_PartyStateChangeResult_System_UInt32_GDK_Net_PlayFab_Party_PartyChatControl_GDK_Net_PlayFab_Party_PartyAudioDeviceSelection_"></a> PartySetChatAudioOutputCompleted\(PartyOperationId, PartyStateChangeResult, uint, PartyChatControl?, PartyAudioDeviceSelection\)

A <xref href="GDK.Net.PlayFab.Party.PartyChatControl.SetAudioOutput(GDK.Net.PlayFab.Party.PartyAudioDeviceSelectionType%2cSystem.String)" data-throw-if-not-resolved="false"></xref> call completed.

```csharp
public PartySetChatAudioOutputCompleted(PartyOperationId Operation, PartyStateChangeResult Result, uint ErrorDetail, PartyChatControl? ChatControl, PartyAudioDeviceSelection Selection)
```
...
### <a id="GDK_Net_PlayFab_Party_PartySetChatAudioOutputCompleted_ChatControl"></a> ChatControl
...
### <a id="GDK_Net_PlayFab_Party_PartySetChatAudioOutputCompleted_Selection"></a> Selection
