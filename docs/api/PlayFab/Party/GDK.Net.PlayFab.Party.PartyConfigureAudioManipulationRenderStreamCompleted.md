# <a id="GDK_Net_PlayFab_Party_PartyConfigureAudioManipulationRenderStreamCompleted"></a> Class PartyConfigureAudioManipulationRenderStreamCompleted

Namespace: [GDK.Net.PlayFab.Party](GDK.Net.PlayFab.Party.md)  
Assembly: GDK.Net.dll  

A <xref href="GDK.Net.PlayFab.Party.PartyChatControl.ConfigureAudioManipulationRenderStream(GDK.Net.PlayFab.Party.PartyAudioManipulationSinkStreamConfiguration)" data-throw-if-not-resolved="false"></xref> call completed.

```csharp
public sealed record PartyConfigureAudioManipulationRenderStreamCompleted : PartyOperationCompleted, IEquatable<PartyStateChange>, IEquatable<PartyOperationCompleted>, IEquatable<PartyConfigureAudioManipulationRenderStreamCompleted>
```
...
[IEquatable<PartyConfigureAudioManipulationRenderStreamCompleted\>](https://learn.microsoft.com/dotnet/api/system.iequatable\-1)
...
### <a id="GDK_Net_PlayFab_Party_PartyConfigureAudioManipulationRenderStreamCompleted__ctor_GDK_Net_PlayFab_Party_PartyOperationId_GDK_Net_PlayFab_Party_PartyStateChangeResult_System_UInt32_GDK_Net_PlayFab_Party_PartyChatControl_GDK_Net_PlayFab_Party_PartyAudioManipulationSinkStreamConfiguration_"></a> PartyConfigureAudioManipulationRenderStreamCompleted\(PartyOperationId, PartyStateChangeResult, uint, PartyChatControl?, PartyAudioManipulationSinkStreamConfiguration?\)

A <xref href="GDK.Net.PlayFab.Party.PartyChatControl.ConfigureAudioManipulationRenderStream(GDK.Net.PlayFab.Party.PartyAudioManipulationSinkStreamConfiguration)" data-throw-if-not-resolved="false"></xref> call completed.

```csharp
public PartyConfigureAudioManipulationRenderStreamCompleted(PartyOperationId Operation, PartyStateChangeResult Result, uint ErrorDetail, PartyChatControl? ChatControl, PartyAudioManipulationSinkStreamConfiguration? Configuration)
```
...
### <a id="GDK_Net_PlayFab_Party_PartyConfigureAudioManipulationRenderStreamCompleted_ChatControl"></a> ChatControl
...
### <a id="GDK_Net_PlayFab_Party_PartyConfigureAudioManipulationRenderStreamCompleted_Configuration"></a> Configuration
