# <a id="GDK_Net_PlayFab_Party_PartyDestroyEndpointCompleted"></a> Class PartyDestroyEndpointCompleted

Namespace: [GDK.Net.PlayFab.Party](GDK.Net.PlayFab.Party.md)  
Assembly: GDK.Net.dll  

A <xref href="GDK.Net.PlayFab.Party.PartyNetwork.DestroyEndpoint(GDK.Net.PlayFab.Party.PartyEndpoint)" data-throw-if-not-resolved="false"></xref> call completed.

```csharp
public sealed record PartyDestroyEndpointCompleted : PartyOperationCompleted, IEquatable<PartyStateChange>, IEquatable<PartyOperationCompleted>, IEquatable<PartyDestroyEndpointCompleted>
```
...
[IEquatable<PartyDestroyEndpointCompleted\>](https://learn.microsoft.com/dotnet/api/system.iequatable\-1)
...
### <a id="GDK_Net_PlayFab_Party_PartyDestroyEndpointCompleted__ctor_GDK_Net_PlayFab_Party_PartyOperationId_GDK_Net_PlayFab_Party_PartyStateChangeResult_System_UInt32_GDK_Net_PlayFab_Party_PartyNetwork_GDK_Net_PlayFab_Party_PartyEndpoint_"></a> PartyDestroyEndpointCompleted\(PartyOperationId, PartyStateChangeResult, uint, PartyNetwork?, PartyEndpoint?\)

A <xref href="GDK.Net.PlayFab.Party.PartyNetwork.DestroyEndpoint(GDK.Net.PlayFab.Party.PartyEndpoint)" data-throw-if-not-resolved="false"></xref> call completed.

```csharp
public PartyDestroyEndpointCompleted(PartyOperationId Operation, PartyStateChangeResult Result, uint ErrorDetail, PartyNetwork? Network, PartyEndpoint? Endpoint)
```
...
The network the endpoint belonged to.
...
### <a id="GDK_Net_PlayFab_Party_PartyDestroyEndpointCompleted_Endpoint"></a> Endpoint
...
### <a id="GDK_Net_PlayFab_Party_PartyDestroyEndpointCompleted_Network"></a> Network
