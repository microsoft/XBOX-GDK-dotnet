# <a id="GDK_Net_XboxLive_UsersAddedToSocialGraphSocialManagerEvent"></a> Class UsersAddedToSocialGraphSocialManagerEvent
...
```csharp
public sealed record UsersAddedToSocialGraphSocialManagerEvent : SocialManagerEvent, IEquatable<SocialManagerEvent>, IEquatable<UsersAddedToSocialGraphSocialManagerEvent>
```
...
[IEquatable<UsersAddedToSocialGraphSocialManagerEvent\>](https://learn.microsoft.com/dotnet/api/system.iequatable\-1)
...
### <a id="GDK_Net_XboxLive_UsersAddedToSocialGraphSocialManagerEvent_Users"></a> Users

The users added to the graph.
