# <a id="GDK_Net_XboxLive_PresenceChangedSocialManagerEvent"></a> Class PresenceChangedSocialManagerEvent
...
```csharp
public sealed record PresenceChangedSocialManagerEvent : SocialManagerEvent, IEquatable<SocialManagerEvent>, IEquatable<PresenceChangedSocialManagerEvent>
```
...
[IEquatable<PresenceChangedSocialManagerEvent\>](https://learn.microsoft.com/dotnet/api/system.iequatable\-1)
...
### <a id="GDK_Net_XboxLive_PresenceChangedSocialManagerEvent_Users"></a> Users

The users whose presence changed.
