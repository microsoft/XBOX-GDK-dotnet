# <a id="GDK_Net_PlayFab_Multiplayer_JoinLobbyCompleted"></a> Class JoinLobbyCompleted
...
```csharp
public sealed record JoinLobbyCompleted : LobbyOperationCompleted, IEquatable<LobbyStateChange>, IEquatable<LobbyOperationCompleted>, IEquatable<JoinLobbyCompleted>
```
...
[IEquatable<JoinLobbyCompleted\>](https://learn.microsoft.com/dotnet/api/system.iequatable\-1)
...
### <a id="GDK_Net_PlayFab_Multiplayer_JoinLobbyCompleted_NewMember"></a> NewMember
