# <a id="GDK_Net_PlayFab_Multiplayer_CreateAndJoinLobbyCompleted"></a> Class CreateAndJoinLobbyCompleted
...
```csharp
public sealed record CreateAndJoinLobbyCompleted : LobbyOperationCompleted, IEquatable<LobbyStateChange>, IEquatable<LobbyOperationCompleted>, IEquatable<CreateAndJoinLobbyCompleted>
```
...
[IEquatable<CreateAndJoinLobbyCompleted\>](https://learn.microsoft.com/dotnet/api/system.iequatable\-1)
