# <a id="GDK_Net_XboxLive_ProfilesChangedSocialManagerEvent"></a> Class ProfilesChangedSocialManagerEvent
...
```csharp
public sealed record ProfilesChangedSocialManagerEvent : SocialManagerEvent, IEquatable<SocialManagerEvent>, IEquatable<ProfilesChangedSocialManagerEvent>
```
...
[IEquatable<ProfilesChangedSocialManagerEvent\>](https://learn.microsoft.com/dotnet/api/system.iequatable\-1)
...
### <a id="GDK_Net_XboxLive_ProfilesChangedSocialManagerEvent_Users"></a> Users

The users whose profile fields changed.
