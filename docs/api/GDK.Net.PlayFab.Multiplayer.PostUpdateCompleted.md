# <a id="GDK_Net_PlayFab_Multiplayer_PostUpdateCompleted"></a> Class PostUpdateCompleted
...
```csharp
public sealed record PostUpdateCompleted : LobbyOperationCompleted, IEquatable<LobbyStateChange>, IEquatable<LobbyOperationCompleted>, IEquatable<PostUpdateCompleted>
```
...
[IEquatable<PostUpdateCompleted\>](https://learn.microsoft.com/dotnet/api/system.iequatable\-1)
...
### <a id="GDK_Net_PlayFab_Multiplayer_PostUpdateCompleted_LocalUser"></a> LocalUser

The local user whose update was posted.
