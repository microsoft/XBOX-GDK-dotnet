# <a id="GDK_Net_PlayFab_Party_PartySetLanguageCompleted"></a> Class PartySetLanguageCompleted

Namespace: [GDK.Net.PlayFab.Party](GDK.Net.PlayFab.Party.md)  
Assembly: GDK.Net.dll  

A <xref href="GDK.Net.PlayFab.Party.PartyChatControl.SetLanguage(System.String)" data-throw-if-not-resolved="false"></xref> call completed.

```csharp
public sealed record PartySetLanguageCompleted : PartyOperationCompleted, IEquatable<PartyStateChange>, IEquatable<PartyOperationCompleted>, IEquatable<PartySetLanguageCompleted>
```
...
[IEquatable<PartySetLanguageCompleted\>](https://learn.microsoft.com/dotnet/api/system.iequatable\-1)
...
### <a id="GDK_Net_PlayFab_Party_PartySetLanguageCompleted__ctor_GDK_Net_PlayFab_Party_PartyOperationId_GDK_Net_PlayFab_Party_PartyStateChangeResult_System_UInt32_GDK_Net_PlayFab_Party_PartyChatControl_System_String_"></a> PartySetLanguageCompleted\(PartyOperationId, PartyStateChangeResult, uint, PartyChatControl?, string?\)

A <xref href="GDK.Net.PlayFab.Party.PartyChatControl.SetLanguage(System.String)" data-throw-if-not-resolved="false"></xref> call completed.

```csharp
public PartySetLanguageCompleted(PartyOperationId Operation, PartyStateChangeResult Result, uint ErrorDetail, PartyChatControl? ChatControl, string? LanguageCode)
```
...
### <a id="GDK_Net_PlayFab_Party_PartySetLanguageCompleted_ChatControl"></a> ChatControl
...
### <a id="GDK_Net_PlayFab_Party_PartySetLanguageCompleted_LanguageCode"></a> LanguageCode
