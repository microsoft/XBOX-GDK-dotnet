# <a id="GDK_Net_PlayFab_Party_PartyCreateInvitationCompleted"></a> Class PartyCreateInvitationCompleted

Namespace: [GDK.Net.PlayFab.Party](GDK.Net.PlayFab.Party.md)  
Assembly: GDK.Net.dll  

A <xref href="GDK.Net.PlayFab.Party.PartyNetwork.CreateInvitation(GDK.Net.PlayFab.Party.PartyLocalUser%2cGDK.Net.PlayFab.Party.PartyInvitationConfiguration)" data-throw-if-not-resolved="false"></xref> call completed.

```csharp
public sealed record PartyCreateInvitationCompleted : PartyOperationCompleted, IEquatable<PartyStateChange>, IEquatable<PartyOperationCompleted>, IEquatable<PartyCreateInvitationCompleted>
```
...
[IEquatable<PartyCreateInvitationCompleted\>](https://learn.microsoft.com/dotnet/api/system.iequatable\-1)
...
### <a id="GDK_Net_PlayFab_Party_PartyCreateInvitationCompleted__ctor_GDK_Net_PlayFab_Party_PartyOperationId_GDK_Net_PlayFab_Party_PartyStateChangeResult_System_UInt32_GDK_Net_PlayFab_Party_PartyNetwork_GDK_Net_PlayFab_Party_PartyLocalUser_GDK_Net_PlayFab_Party_PartyInvitation_"></a> PartyCreateInvitationCompleted\(PartyOperationId, PartyStateChangeResult, uint, PartyNetwork?, PartyLocalUser?, PartyInvitation?\)

A <xref href="GDK.Net.PlayFab.Party.PartyNetwork.CreateInvitation(GDK.Net.PlayFab.Party.PartyLocalUser%2cGDK.Net.PlayFab.Party.PartyInvitationConfiguration)" data-throw-if-not-resolved="false"></xref> call completed.

```csharp
public PartyCreateInvitationCompleted(PartyOperationId Operation, PartyStateChangeResult Result, uint ErrorDetail, PartyNetwork? Network, PartyLocalUser? LocalUser, PartyInvitation? Invitation)
```
...
The network the invitation belongs to.
...
The created invitation, when the call succeeded.

## Properties

### <a id="GDK_Net_PlayFab_Party_PartyCreateInvitationCompleted_Invitation"></a> Invitation
...
### <a id="GDK_Net_PlayFab_Party_PartyCreateInvitationCompleted_LocalUser"></a> LocalUser
...
### <a id="GDK_Net_PlayFab_Party_PartyCreateInvitationCompleted_Network"></a> Network
