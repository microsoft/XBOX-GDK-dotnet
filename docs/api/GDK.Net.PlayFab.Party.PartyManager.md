...
#### Returns
 ...
 \([PartyOperationId](GDK.Net.PlayFab.Party.PartyOperationId.md) [Operation](https://learn.microsoft.com/dotnet/api/system.valuetuple\-gdk.net.playfab.party.partyoperationid,gdk.net.playfab.party.partynetwork\-.operation), [PartyNetwork](GDK.Net.PlayFab.Party.PartyNetwork.md) [Network](https://learn.microsoft.com/dotnet/api/system.valuetuple\-gdk.net.playfab.party.partyoperationid,gdk.net.playfab.party.partynetwork\-.network)\)
...
#### Returns
 ...
 \([PartyOperationId](GDK.Net.PlayFab.Party.PartyOperationId.md) [Operation](https://learn.microsoft.com/dotnet/api/system.valuetuple\-gdk.net.playfab.party.partyoperationid,gdk.net.playfab.party.partynetworkdescriptor,system.string\-.operation), [PartyNetworkDescriptor](GDK.Net.PlayFab.Party.PartyNetworkDescriptor.md) [Descriptor](https://learn.microsoft.com/dotnet/api/system.valuetuple\-gdk.net.playfab.party.partyoperationid,gdk.net.playfab.party.partynetworkdescriptor,system.string\-.descriptor), [string](https://learn.microsoft.com/dotnet/api/system.string) [InvitationIdentifier](https://learn.microsoft.com/dotnet/api/system.valuetuple\-gdk.net.playfab.party.partyoperationid,gdk.net.playfab.party.partynetworkdescriptor,system.string\-.invitationidentifier)\)
