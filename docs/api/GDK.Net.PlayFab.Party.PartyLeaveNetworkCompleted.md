# <a id="GDK_Net_PlayFab_Party_PartyLeaveNetworkCompleted"></a> Class PartyLeaveNetworkCompleted

Namespace: [GDK.Net.PlayFab.Party](GDK.Net.PlayFab.Party.md)  
Assembly: GDK.Net.dll  

A <xref href="GDK.Net.PlayFab.Party.PartyNetwork.Leave" data-throw-if-not-resolved="false"></xref> call completed.

```csharp
public sealed record PartyLeaveNetworkCompleted : PartyOperationCompleted, IEquatable<PartyStateChange>, IEquatable<PartyOperationCompleted>, IEquatable<PartyLeaveNetworkCompleted>
```
...
[IEquatable<PartyLeaveNetworkCompleted\>](https://learn.microsoft.com/dotnet/api/system.iequatable\-1)
...
### <a id="GDK_Net_PlayFab_Party_PartyLeaveNetworkCompleted__ctor_GDK_Net_PlayFab_Party_PartyOperationId_GDK_Net_PlayFab_Party_PartyStateChangeResult_System_UInt32_GDK_Net_PlayFab_Party_PartyNetwork_"></a> PartyLeaveNetworkCompleted\(PartyOperationId, PartyStateChangeResult, uint, PartyNetwork?\)

A <xref href="GDK.Net.PlayFab.Party.PartyNetwork.Leave" data-throw-if-not-resolved="false"></xref> call completed.

```csharp
public PartyLeaveNetworkCompleted(PartyOperationId Operation, PartyStateChangeResult Result, uint ErrorDetail, PartyNetwork? Network)
```
...
### <a id="GDK_Net_PlayFab_Party_PartyLeaveNetworkCompleted_Network"></a> Network
